...
public class WeChatMsgType
{
    ...
    public static final int WECHAT_MESSAGE_TYPE_MSG_CARD = 49;       //小程序
    public static final int WECHAT_MESSAGE_TYPE_CHATROOM_NEW_MEMBER = 10002;         //新人入群信息
    public static final int WECHAT_MESSAGE_TYPE_UNKNOWN = 570425393;        //貌似是新人入群信息
}
